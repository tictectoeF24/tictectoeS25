...
export function ProfilePage() {
  ...
  const getUserFollowingNumber = () => {
    return following.length;
  };

  const getUserFollowersNum = () => {
              ...
              <View style={tw`flex-row justify-between mb-3`}>
                ...
                >
                  <FontAwesome
                      name="edit"
                      size={20}
                      color={isDarkmode ? "#7CC288" : "#057B34"}
                      style={tw`mr-2`}
                  />
                  <Text
                      style={{
